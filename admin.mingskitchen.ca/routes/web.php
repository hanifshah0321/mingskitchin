...
// paypal for plan
Route::any('planpayWithpaypal/{customer_id}/{order_amount}/{membership_id}', 'PaypalPaymentController@planpayWithpaypal')->name('planpayWithpaypal');
Route::get('plan-paypal-status', 'PaypalPaymentController@plangetPaymentStatus')->name('plan-paypal-status');
