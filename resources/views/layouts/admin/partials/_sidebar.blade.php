            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content">
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="nav-item">
                            <small
                                class="nav-subtitle">{{translate('Book')}} {{translate('Table')}}</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>

                          <li class="navbar-vertical-aside-has-menu {{Request::is('admin/customer/userbooktable*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.customer.userbooktable')}}"
                                >
                                    <i class="tio-format-points nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{translate('Book Table')}}
                                    </span>
                                </a>
                            </li>
                              ...
                              <li class="navbar-vertical-aside-has-menu {{Request::is('admin/employee*')?'active':''}}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li class="nav-item {{Request::is('admin/employee/add-new')?'active':''}}">
                                        <a class="nav-link " href="{{route('admin.membership.add-new')}}">
                                            <span class="tio-circle nav-indicator-icon"></span>
                        ...
                        @if(Helpers::module_permission_check(MANAGEMENT_SECTION['customer_management']))
                            ...
                            <li class="navbar-vertical-aside-has-menu {{Request::is('admin/customer/transaction*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   href="{{route('admin.customer.usermembership')}}"
                                >
                                    <i class="tio-format-points nav-icon"></i>
                                    <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                        {{translate('User Memebership')}}
                                    </span>
                                </a>
                            </li>
