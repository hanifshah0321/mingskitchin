...
<div class="content container-fluid">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">User Membership</li>
                    ...
                    <div class="table-responsive">
                        <table id="datatable" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            ...
                            @foreach($em as $k=>$e)
                                ...
                                <tr>
                                    <th scope="row">{{$k+1}}</th>
                                    <td class="text-capitalize">{{$e->user->f_name}} {{$e->user->l_name}}</td>
                                    <td >{{ $e->usermembershipplan->title }}</td>
                                     <td>{{ $e->usermembershipplan->price }}</td>
                                     <td>{{$e->buy_at}}</td>
                                     <td>{{$e->expire_at}}</td>
                                   <!--  <td>
